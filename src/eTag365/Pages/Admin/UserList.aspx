<%@ Page Title="Patient Listing" Language="C#" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="UserList.aspx.cs" Inherits="eTag365.Pages.Admin.UserList" %>
                ...
                <div class="box">
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-header with-border CommonHeader col-md-12">
                                <h3 class="box-title" id="H1" runat="server">Patient List</h3>
                            </div>

                            <div class="box-body">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <label class="col-sm-3 control-label" style="float: left;">User:</label>
                                        <div class="col-sm-6">
