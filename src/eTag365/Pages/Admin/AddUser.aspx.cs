    ...
    public partial class AddUser : System.Web.UI.Page
    {
            ...
            try
            {
                if (nId > 0)
                {
                    ...
                    if (obj != null)
                    {
                        ...
                        if (obj.CanLogin != null && obj.CanLogin.ToString() != string.Empty)
                        {
                            CanLogin.Checked = Convert.ToBoolean(obj.CanLogin);
                        }
                        else
                        {
                            CanLogin.Checked = false;
        ...
        public static string uploadprofilepicture(string Image, string ImageName)
        {
            ...
            try
            {
                ...
                string direc = "~/nfc/Uploads/";
                string uploadPath = "~/nfc/Uploads/Files/User";
                ...
                try
                {
                    if (new UserProfileDA().Update(obj))
                    {
                        ...
                        sImage = "../../nfc/Uploads/Files/User/" + sfile;
                    }
                }
                catch (Exception)
                {
        ...
        public System.Text.StringBuilder EmailHtmlToAdmin(int nUserId)
        {
            ...
            string sSQL = " Select isnull(Password,'') Password,isnull(Email,'') Email,isnull(Phone,'') Phone,isnull(FirstName,'') FirstName,isnull(LastName,'') LastName,isnull(Title,'') Title,isnull(CompanyName,'') CompanyName,isnull(WorkPhone,'') WorkPhone,isnull(Address,'') Address, isnull(Other,'') Other from UserProfile where Id = " + nUserId.ToString();
            DataTable dtResult = SqlToTbl(sSQL);
            try
            {
                emailbody.Append("<table>");
                emailbody.Append("<tr><td colspan='2'></td></tr>");
                emailbody.Append("<tr><td colspan='2'><img  alt='' width='120' src='" + sWeb + "/Images/logo.png'></td></tr>");
                emailbody.Append("<tr><td colspan='2'></td></tr>");
                emailbody.Append("<tr><td colspan='2'></td></tr>");
                ...
                if (dtResult != null && dtResult.Rows.Count > 0)
                {
                  //  sCell = (dtResult.Rows[0]["Phone"] != null && dtResult.Rows[0]["Phone"] != DBNull.Value) ? dtResult.Rows[0]["Phone"].ToString() : "";
                    ...
                    emailbody.Append("<tr><td>Emergency Contact Number: </td><td> " + ((dtResult.Rows[0]["WorkPhone"] != null && dtResult.Rows[0]["WorkPhone"] != DBNull.Value) ? dtResult.Rows[0]["WorkPhone"].ToString() : "") + " </td></tr>");
                    emailbody.Append("<tr><td>Age: </td><td> " + ((dtResult.Rows[0]["Title"] != null && dtResult.Rows[0]["Title"] != DBNull.Value) ? dtResult.Rows[0]["Title"].ToString() : "") + " </td></tr>");
                    emailbody.Append("<tr><td>Blood Group: </td><td> " + ((dtResult.Rows[0]["CompanyName"] != null && dtResult.Rows[0]["CompanyName"] != DBNull.Value) ? dtResult.Rows[0]["CompanyName"].ToString() : "") + " </td></tr>");
                    emailbody.Append("<tr><td>Medical Records: </td><td> " + ((dtResult.Rows[0]["Other"] != null && dtResult.Rows[0]["Other"] != DBNull.Value) ? dtResult.Rows[0]["Other"].ToString() : "") + " </td></tr>");
        ...
        public System.Text.StringBuilder EmailHtml(int nUserId)
        {
            ...
            try
            {
                ...
                emailbody.Append("<tr><td colspan='2'></td></tr>");
                emailbody.Append("<tr><td colspan='2'></td></tr>");
                emailbody.Append("<tr><td colspan='2'><p>ePatient has created your very secure contact information manager account. Please complete your profile. Press the following link. </p> </td></tr>");
                emailbody.Append("<tr><td colspan='2'></td></tr>");
