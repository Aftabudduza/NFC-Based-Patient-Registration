<%@ Page Title="Global System Info" Language="C#" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="AddGlobalSystem.aspx.cs" Inherits="eTag365.Pages.Admin.AddGlobalSystem" %>
                ...
                <div class="box">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border CommonHeader col-md-12">
                                <h3 class="box-title" id="lblHeadline" runat="server"> Global System Information</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <div class="box-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-6">
                                <asp:CheckBox ID="chkIncludeFee" runat="server" Text=" pays processing fees" CssClass="col-sm-12 form-check-inline" />
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <label class="col-sm-12 control-label">
                                    <h6>*  Monthly & Annual Software Charges:</h6>
                                </label>
