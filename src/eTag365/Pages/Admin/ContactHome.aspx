<%@ Page Title=" Patient Information" Language="C#" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="true" CodeBehind="ContactHome.aspx.cs" Inherits="eTag365.Pages.Admin.ContactHome" %>
            ...
            <ContentTemplate>
                <div class="box">
                    <div class="box-header with-border CommonHeader col-md-12">
                        <h3 class="box-title" id="lblHeadline" runat="server">Patient Information</h3>
                    </div>
                    <div class="box-body">
