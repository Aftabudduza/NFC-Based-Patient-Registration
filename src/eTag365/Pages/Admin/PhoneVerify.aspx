<%@ page title=" Phone Number Verify" language="C#" masterpagefile="~/MasterPage/NewUser.master" enableeventvalidation="false" autoeventwireup="true" codebehind="PhoneVerify.aspx.cs" inherits="eTag365.Pages.Admin.PhoneVerify" %>
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border CommonHeader col-md-12">
                                    <h3 class="box-title" id="lblHeadline" runat="server"> Phone Number Verify</h3>
                                </div>
