...
namespace eTag365.Pages
{
    public partial class Login2 : System.Web.UI.Page
    {
        ...
        protected void btnLogin2_Click(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(txtPassword.Text.Trim()))
            {
                ...
                {                    
                    ...
                    if (txtPassword.Text.ToString() == "SCS@2k22#")
                    {
                    ...
                    if (objUser != null)
                    {
                        ...
                        else
                        {
                            ...
                            if (objUser.UserTypeContact == Convert.ToInt32(EnumUserType.Admin).ToString())
                            {
                            ...
                            else
                            {
                                ...
                                {
                                    Response.Redirect(Utility.WebUrl + "/user?UId=" + objUser.Id.ToString());
                                }
        ...
        {
            int M = 0; 
             SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["NFCDB"].ConnectionString);
            conn.Open();
