<%@ Page Title=" Forgotten Password" Language="C#" MasterPageFile="~/MasterPage/NewUser.master" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="eTag365.Pages.ForgotPassword" %>
                ...
                <div class="box">
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="col-md-6">
                                    <label for="txtNumber" class="col-sm-3 control-label">Mobile Number:</label>
                                    <div class="col-sm-6">
