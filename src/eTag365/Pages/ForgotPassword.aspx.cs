    ...
    public partial class ForgotPassword : System.Web.UI.Page
    {
        ...
        public bool SendEmail(string sEmail)
        {
            ...
            try
            {
                ...
                objMailMessage.From = new System.Net.Mail.MailAddress(from_address, "NFC Support");
                objMailMessage.To.Add(new System.Net.Mail.MailAddress(to_address));
                objMailMessage.Subject = "Forgot Password Request";
        ...
        public System.Text.StringBuilder EmailHtml(string sEmail)
        {
            ...
            try
            {
                ...
                emailbody.Append("<tr><td colspan='2'></td></tr>");
                emailbody.Append("<tr><td colspan='2'><p>NFC Team</p> </td></tr>");
                emailbody.Append("</table>");
            }
            catch (Exception ex)
            {
