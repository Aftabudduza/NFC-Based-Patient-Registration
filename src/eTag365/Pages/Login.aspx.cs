...
namespace eTag365.Pages
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        private UserProfile SetData(UserProfile obj)
        {
            ...
            obj.Country = ddlCountry.SelectedValue != "-1" ? ddlCountry.SelectedValue : "BD";
            obj.Longitude = "";
            obj.Latitude = "";           
                ...
                try
                {
                    ...
                    if (objUser != null)
                    {
                        ...
                        if (objUser.IsNewUser != null && objUser.IsNewUser == false)
                        {
                            ...
                            else
                            {
                                ...
                                if (sPhone != "" && sCode != "")
                                {
                                    string sMessage = "Your Verification Code - " + sCode;
                    ...
                    else
                    {
                        ...
                        if (new UserProfileDA(true, false).Insert(objUser))
                        {
                            ...
                            {
                                string sMessage = "ePatient Management has created your very secure contact information manager account. Please complete your profile.  Enter this mobile number for Username and Password you want and fill out the rest of the form. Thank you.";
                                if (sendSMS(sPhone, sMessage))
                                {
        ...
        public bool SendEmailToAdmin(int nUserId)
        {
            ...
            try
            {
                ...
                objMailMessage.From = new System.Net.Mail.MailAddress(from_address, "ePatient Management Support");
                objMailMessage.To.Add(new System.Net.Mail.MailAddress(to_address));
                objMailMessage.Subject = "New user Registration request from ePatient Management";
        ...
        public System.Text.StringBuilder EmailHtmlToAdmin(int nUserId)
        {
            ...
            try
            {
                ...
                emailbody.Append("<tr><td colspan='2'></td></tr>");
                emailbody.Append("<tr><td colspan='2'></td></tr>");
                emailbody.Append("<tr><td colspan='2'><p>ePatient Management has created a new user. </p> </td></tr>");
                emailbody.Append("<tr><td colspan='2'></td></tr>");
                string sCell = "";
                string sPassword = "";
                ...
                emailbody.Append("<tr><td colspan='2'></td></tr>");
                emailbody.Append("<tr><td colspan='2'><p>ePatient Management Team</p> </td></tr>");
                emailbody.Append("</table>");
            }
            catch (Exception ex)
            {
