<%@ Page Language="C#" Title=" Login" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Login2.aspx.cs" Inherits="eTag365.Pages.Login2" %>
...
<body class="login" style="background-color: #fff;">
    <div id="log-header">
        <img alt="Logo" src="https://etag365.net/epatient/Images/logo.png" id="login-logo" />
    </div>
    <div id="login-wrap">
                    ...
                    <form id="form1" runat="server" class="form-vertical">
                        <div class="control-group-merged">
                         ...
                         <div style="text-align: center;">
                           <a style="margin-left: 5px;" href="https://etag365.net/epatient/forget-password">Forgot Your Password?</a>
                        </div>
                        <div style="text-align: center;">
                        ...
                        <div class="separator" style="margin-top: 20px;">
                            <div class="login_footer" style="text-align:center;">
                                <h1 style="margin-bottom: 20px;"><i class="fa fa-paw"></i>ePatient
                                </h1>
                                <p>Copyright &copy; <span id="spanYear" runat="server"></span>. All rights reserved.</p>
