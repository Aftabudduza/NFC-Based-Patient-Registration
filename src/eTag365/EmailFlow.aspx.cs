    ...
    public partial class EmailFlow : System.Web.UI.Page  
    {
        ...
        public bool SendEmail()
        {
            ...
            try
            {
                ...
                string from_address = "info@eproperty365.com";
                string to_address = "aftabudduza@gmail.com";


                objMailMessage = new System.Net.Mail.MailMessage();
                objMailMessage.From = new System.Net.Mail.MailAddress(from_address, "eproperty365");
                objMailMessage.To.Add(new System.Net.Mail.MailAddress(to_address));
                objMailMessage.Subject = "eproperty365 Email Template";
                objMailMessage.IsBodyHtml = true;
                objMailMessage.Body = "This is a test";
                //objMailMessage.BodyEncoding = System.Text.Encoding.UTF8;
                //objMailMessage.SubjectEncoding = System.Text.Encoding.UTF8;
                //objSmtpClient.TargetName = "STARTTLS/mail.eproperty365.com";
