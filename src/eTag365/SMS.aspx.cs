                ...
                if (numbersToMessage != null)
                {
                    ...
                    try
                    {
                        if (sSuccess.Length > 0)
                        {
                            ...
                            {
                                writer.WriteLine(DateTime.Now.ToString() + " -  SMS sent successfully To following numbers:  " + "\n");
                            }
                    ...
                    try
                    {
                        if (sFail.Length > 0)
                        {
                            ...
                            {
                                writer.WriteLine(DateTime.Now.ToString() + " - SMS sending failed To following numbers:" + "\n");
                            }
